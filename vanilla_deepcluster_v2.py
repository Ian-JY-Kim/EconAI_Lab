...
def main(args):
    ...
    model.fc = nn.Linear(512, args.nmb_cluster)
    ...
    trainset = GPSDataset('./meta_data/inhabited_metadata.csv', './unlabelled_images', train_transform1)
    ...
    for epoch in range(0, args.epochs):
        ...
        for batch_idx, (inputs, indexes) in enumerate(trainloader):
            ...
            if batch_idx % 20 == 0:
                torch.save(model.state_dict(), './checkpoint/ckpt_vanilla_cluster_lao_z14_50_pretrained.t7'.format(args.mode))
